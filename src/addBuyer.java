...
public class addBuyer extends javax.swing.JFrame {
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        // TODO add your handling code here:
         if(jTextField3.getText().equals("Enter Age"))
        {
            jTextField3.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int caseno = Integer.parseInt(jTextField5.getText());
        ...
        try {
            ...
            st.executeUpdate();
            JOptionPane.showMessageDialog(null, "Patient Succesfully added");
            setVisible(false);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            ResultSet rs= st.executeQuery("select max(caseNo) from patient;");
            if(rs.next())
            {
                jTextField5.setText((rs.getInt(1)+1)+"");
            }
            else
            {
